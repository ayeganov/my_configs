...
PROMPT='╭ %{$fg_bold[green]%}%p%{$fg[yellow]%}%j ${ret_status} %{$fg_bold[green]%}%n@%M:%{$fg[blue]%}%~ %{$fg_bold[cyan]%}$(_virtualenv_prompt_info)$(_pyenv_prompt_info)$(_docker_prompt_info)$(_git_prompt_info)$(_hg_prompt_info)%{$fg_bold[blue]%} % %{$reset_color%}
╰ ➤ '
